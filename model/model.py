...
load_dotenv(dotenv_path='/Users/ahmedawad/Desktop/backup/.env')
...
#         download_blob_to_file('best_sentiment_analysis_model.pth', os.getenv("MODEL_PATH"))
#     if not os.path.exists(os.getenv("TOKENIZER_PATH")):
#         download_blob_to_file('tokenizer.json', os.getenv("TOKENIZER_PATH"))
    # if not os.path.exists(os.getenv("EMBEDDING_PATH")):
    #     download_blob_to_file('embedding_matrix.npy', os.getenv("EMBEDDING_PATH"))
...
def predict_sentiment(input_tensor):
